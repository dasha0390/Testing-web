...
<section class="relative overflow-hidden bg-ink-800">
    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-8 py-20 lg:py-28 grid lg:grid-cols-5 gap-12 items-center relative">
        ...
        {{-- Signature: kartu "rapor prestasi" --}}
            ...
            <div class="bg-paper rounded-2xl shadow-2xl p-7 rotate-1 hover:rotate-0 transition-transform duration-300">
                ...
                <dl class="divide-y divide-ink-100">
                    <div class="flex items-center justify-between py-3">
                        <dt class="text-ink-700">Siswa Aktif</dt>
                        <dd class="font-display text-2xl text-ink-800">{{ number_format($pengaturan->jumlah_siswa ?? 0) }}+</dd>
                    </div>
                    <div class="flex items-center justify-between py-3">
                        <dt class="text-ink-700">Tenaga Pendidik</dt>
                        <dd class="font-display text-2xl text-ink-800">{{ number_format($pengaturan->jumlah_guru ?? 0) }}+</dd>
                    </div>
                    <div class="flex items-center justify-between py-3">
                        <dt class="text-ink-700">Prestasi Diraih</dt>
                        <dd class="font-display text-2xl text-ink-800">{{ number_format($pengaturan->jumlah_prestasi ?? 0) }}+</dd>
                    </div>
                    <div class="flex items-center justify-between py-3">
                        <dt class="text-ink-700">Tahun Pengalaman</dt>
                        <dd class="font-display text-2xl text-ink-800">{{ $pengaturan->tahun_berdiri ? date('Y') - $pengaturan->tahun_berdiri : '—' }}</dd>
                    </div>
                </dl>
            </div>
        </div>
